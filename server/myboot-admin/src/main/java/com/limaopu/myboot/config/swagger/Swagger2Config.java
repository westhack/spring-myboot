package com.limaopu.myboot.config.swagger;
...
public class Swagger2Config {
    ...
    @Value("${swagger.termsOfServiceUrl:http://myboot.limaopu.com}")
    ...
    @Value("${swagger.contact.email:452855489@qq.com}")
