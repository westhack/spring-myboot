...
public class User extends BaseEntity {
    ...
    @ApiModelProperty(value = "是否是后台用户")
    ...
    public String getStatusText() {
        if (CommonConstant.USER_STATUS_NORMAL.equals(this.status)) {
            return "正常";
        } else if (CommonConstant.USER_STATUS_LOCK.equals(this.status)) {
            return "锁住";
        } else if (CommonConstant.USER_STATUS_BAN.equals(this.status)) {
            return "禁用";
        } else if (CommonConstant.USER_STATUS_REVIEW.equals(this.status)) {
            return "待审核";
        }
        return "-";
    }
