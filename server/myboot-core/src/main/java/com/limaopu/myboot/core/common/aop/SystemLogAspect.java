package com.limaopu.myboot.core.common.aop;
...
import com.limaopu.myboot.core.common.utils.ThreadPoolUtil;
import com.limaopu.myboot.core.config.filter.ResponseWrapper;
...
public class SystemLogAspect {
    ...
    @Pointcut("@annotation(com.limaopu.myboot.core.common.annotation.SystemLog)")
    ...
    public void after(JoinPoint joinPoint, Object rvt) {
        ...
        try {
            ...
            String resp = null;
            try {
                resp = JSONUtil.parse(rvt).toString();
            } catch (NullPointerException e) {
            ...
            if (esRecord) {
                ...
                // 日志请求url
                esLog.setRequestUrl(requestUrl);
                // 请求方式
                esLog.setMethod(request.getMethod());
                // 请求参数
                esLog.setBody(body);

                esLog.setAgent(agent);
                ...
                esLog.setLatency(logElapsedTime.intValue());
                esLog.setStatus(status);
                esLog.setResp(resp);
                esLog.setUserId(userId);
                ...
                // 请求耗时
                Long logElapsedTime = endTime - beginTime;
                log.setLatency(logElapsedTime.intValue());
