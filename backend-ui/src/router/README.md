...
| hiddenHeader | *特殊 隐藏 [PageHeader](https://github.com/sendya/ant-design-pro-vue/blob/master/src/components/layout/PageHeader.vue#L14) 组件中的页面带的 面包屑和页面标题栏 | boolean | false  |
        ...
        children: [
          {
            ...
            // 该页面隐藏面包屑和页面标题栏
            meta: { title: '成功', hiddenHeader: true, permission: [ 'result' ] }
          },
          {
            path: '/result/fail',
            name: 'ResultFail',
            ...
            // 该页面隐藏面包屑和页面标题栏
            meta: { title: '失败', hiddenHeader: true, permission: [ 'result' ] }
          }
        ]
      },
      ...
