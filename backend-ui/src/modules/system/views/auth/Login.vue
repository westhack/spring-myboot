<template>
  <div class="main">
    ...
    >
          ...
          <a-form-item>
            <a-row :gutter="16">
              ...
              <a-col class="gutter-row" :span="8">
                <img
                  :src="imgCaptcha.picPath"
                  @click.stop.prevent="getImgCaptcha"
                  v-text="!state.smsSendBtn && '获取验证码' || (state.time+' s')"
                  width="110px"
                  height="36px"
                  style="border: #9E9E9E solid 1px">
              </a-col>
            </a-row>
          </a-form-item>
      ...
      <a-form-item>
        <a-checkbox v-decorator="['rememberMe']" :checked="rememberMe" @change="onChange">自动登录</a-checkbox>
        <a
          @click="forgePassword"
...
export default {
  ...
  methods: {
    ...
    handleSubmit (e) {
      ...
      const validateFieldsKey = customActiveKey === 'tab1' ? ['username', 'password', 'code'] : ['mobile', 'smsCode']
      ...
      validateFields(validateFieldsKey, { force: true }, (err, values) => {
        if (!err) {
          ...
          loginParams.captchaId = this.imgCaptcha.captchaId
          window.log(loginParams)
          Login(loginParams)
