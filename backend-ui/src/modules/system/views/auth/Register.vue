    ...
    <a-form ref="formRegister" :form="form" id="formRegister">
      ...
      <a-form-item>
        <a-input
          ...
          autocomplete="false"
          placeholder="确认密码"
          v-decorator="['passwordConfirmation', {rules: [{ required: true, message: '至少6位密码，区分大小写' }, { validator: this.handlePasswordCheck }], validateTrigger: ['change', 'blur']}]"
        ></a-input>
      </a-form-item>
...
import { getSmsCaptcha, register } from '@/modules/system/api/auth'
      ...
      validateFields(['mobile'], { force: true },
        (err, values) => {
          if (!err) {
            ...
            getSmsCaptcha({ mobile: values.mobile, key: 'register' }).then(res => {
